/* firstnum          Release 1.08b-20250331
   ----------------------------------------
   ...
   -std=c99 Firstnum108b.c -o firstnum -lm
   ...
   Ultima Release (stabile) GNU-GCC:  1.08b
   ----------------------------------------
   ...
   ED ALLA RIGA 134 = "108b-20250331"
...
/* ---------------------------------------------------------- */
#define RELEASE  "1.08b-20250331"    /* Versione di Rilascio. */
/* ---------------------------------------------------------- */
         ...
         /* +++ Contributo nascosto +++ */
            ...
            /* Manuale rapido integrato, Very Good! */
               ...
               if(lang==ITALIANO) {
                  ...
                  printf(" The  '-nT'  and '-pT'  options allow you to compute numeric series with\n");
                  printf(" lengths up to 262144 elements a time.\n\n");
                  printf(" %s -nT 99 999\n",nprg);
...
/* Controllo opzioni per la stampa del rapporto di testa. */
      ...
      if(lang==ENGLISH) {
         ...
         if(option==VARS||option==KEYS)
            printf("(Displayed filtered numeric series)\n\n");
         else putchar('\n');
      }
      else if(lang==ITALIANO) {
         printf("\nScomposizione in fattori primi da %lu a %lu\n",num,limit);
         if(option==VARS||option==KEYS)
            printf("(Serie numerica visualizzata filtrata)\n\n");
         else putchar('\n');
      }
      else if(lang==ESPANOL) {
         printf("\nFactorización prima de %lu a %lu\n",num,limit);
         if(option==VARS||option==KEYS)
            printf("(Se muestran series numéricas filtradas)\n\n");
         else putchar('\n');
      }
      else if(lang==FRANCAIS) {
         printf("\nFactorisation première de %lu à %lu\n",num,limit);
         if(option==VARS||option==KEYS)
            printf("(Série numérique filtrée affichée)\n\n");
         else putchar('\n');
      }
      else if(lang==PORTUGUES) {
         printf("\nFatoração principal de %lu para %lu\n",num,limit);
         if(option==VARS||option==KEYS)
            printf("(Séries numéricas filtradas exibidas)\n\n");
         else putchar('\n');
      }
      else if(lang==DEUTCHE) {
         printf("\nPrimfaktorzerlegung von %lu bis %lu\n",num,limit);
         if(option==VARS||option==KEYS)
            printf("(Angezeigte gefilterte Zahlenreihen)\n\n");
         else putchar('\n');
      }
      else {
